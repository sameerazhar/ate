...
<html>
	<head>
		...
		<script type="text/javascript" src = "./js/facultyQuizzes.js"></script>
	</head>
											...
											<div class="row">
												<div class="col-sm-12">
													...
													<?php echo "<tr id =\"row" . $row["quiz_id"] . "\">"; ?>
														...
														<td>
															<center><a href = <?php echo "./facultyViewQuiz.php?course=" . $course_code . "&quiz=" . $row["quiz_id"]; ?> >View</a></center>
														</td>
														<td>
													<?php
																$enable = "Enable";
