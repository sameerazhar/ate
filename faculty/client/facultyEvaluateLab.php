											...
											<div class="row">
												<div class="col-sm-12">
													<ul class="nav nav-tabs">
														<li><a href=<?php echo "./facultyUploadLab.php?course=" . $course_code; ?> >Upload new Assignment</a></li>
														<li class="active"><a href=<?php echo "./facultyEvaluateLab.php?course=" . $course_code; ?> >Evaluate Assignment</a></li>
