...
<html>
	...
	<body style="background-color:#F0F0F0;">
											...
											<div class="row">
												<div class="col-sm-12">
													<ul class="nav nav-tabs">
														<li class="active"><a href=<?php echo "/ate/faculty/client/facultyUploadLab.php?course=" . $course_code; ?> >Upload new Assignment</a></li>
														<li><a href=<?php echo "/ate/faculty/client/facultyEvaluateLab.php?course=" . $course_code; ?> >Evaluate Assignment</a></li>
		...
		<script type="text/javascript" src = "/ate/bootstrap/js/angular.js"></script>
		<script type="text/javascript" src = "/ate/faculty/client/js/facultyUploadLab.js"></script>
