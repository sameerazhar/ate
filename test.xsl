...
<tr>
<td class="SummaryNumber"><xsl:value-of select="count(//duplication[@lines>0])"/></td>
<td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>0]/@lines)"/></td>
<td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>0]/@tokens)"/></td>
<td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>0]/@tokens) * 4"/></td>
</tr>
</table>
<p/>
...
<xsl:for-each select="//duplication[@lines>0]">
