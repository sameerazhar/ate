...
<html>
	...
	<body style="background-color:#F0F0F0;">
	    	...
	    	<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		        	<ul class="nav navbar-nav  navbar-right">
		            	<li><a href="/ate/student/client/registerCourses.php" style="color:white">Register Courses</a></li>
						<li class = "dropdown active">
						<a href="#" class = "dropdown-toggle" id = "username" data-toggle = "dropdown" style="color:white">USERNAME <b class = "caret"></b></a>
						<ul class = "dropdown-menu">
							<li><a href="/ate/student/client/changePasswordStudent.php">Change Password</a></li>
								...
								<?php
									...
									else
									{
										for( $var = 0; $var < $num; $var++ )
										{
											...
											echo "<a href=\"/ate/student/client/studentLab.php?course=" . $row["course_code"] . "\" id=\"sem\"  class=\"list-group-item\">". $row["course_code"] . " - " . $row["course_name"] . "</a>";
										}
									}
								?>
							</div>
		...
		<script type="text/javascript" src = "/ate/student/client/js/student.js"></script>
