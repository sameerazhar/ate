...
<html>
	<head>
		...
		<script type="text/javascript" src = "/ate/student/client/js/registerCourses.js"></script>
	</head>
	    	...
	    	<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		        	<ul class="nav navbar-nav  navbar-right">
		            	<li class="active"><a href="/ate/student/client/registerCourses.php" style="color:white">Register Courses</a></li>
						<li class = "dropdown">
